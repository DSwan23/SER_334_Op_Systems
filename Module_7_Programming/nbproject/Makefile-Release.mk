...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/module_7_programming
...
${OBJECTDIR}/SwansonInstanceHost.o: SwansonInstanceHost.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SwansonInstanceHost.o SwansonInstanceHost.c

${OBJECTDIR}/SwansonLoadBalancer.o: SwansonLoadBalancer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SwansonLoadBalancer.o SwansonLoadBalancer.c
